...
/**
 * Event emitted for an assistant-role response.
 *
 * @param provider LLM provider that produced the response.
 * @param message Assistant response message.
 * @param arguments Optional structured arguments captured alongside a text response.
 */
